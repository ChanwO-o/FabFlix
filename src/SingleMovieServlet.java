...
public class SingleMovieServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String query = "select movies.title, movies.year, movies.director, group_concat(stars.id) as stars_id, group_concat(distinct genres.name order by genres.name) as genres, group_concat(stars.name) as stars,ratings.rating " +
